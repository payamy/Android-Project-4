...
import com.example.rhodium.UI.CellsInfo.CellInfoAdaptor;
...
public class ReadDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv=(RecyclerView)findViewById(R.id.Cell_List);
    ...
    private void getData() {
        ...
        class GetData extends AsyncTask<Void,Void, List<Parameter>> {
            ...
            protected void onPostExecute(List<Parameter> myDataList) {
                CellInfoAdaptor adapter=new CellInfoAdaptor(myDataList);
